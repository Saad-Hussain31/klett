...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v4.3.5"
  WORKING_DIRECTORY "/home/saad/personal/klett/sor/build_gui/_deps/libzmq-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/saad/personal/klett/sor/build_gui/_deps/libzmq-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/saad/personal/klett/sor/build_gui/_deps/libzmq-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
